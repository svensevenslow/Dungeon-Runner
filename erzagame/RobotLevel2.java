...
public class RobotLevel2 {
	...
	private Background bg1 = GameScreen2.getBg1();
	private Background bg2 = GameScreen2.getBg2();

	private ArrayList<ProjectileLevel2> projectiles = new ArrayList<ProjectileLevel2>();
	...
	public void shoot() {
		if (readyToFire) {
			ProjectileLevel2 p = new ProjectileLevel2(centerX + 50, centerY - 25);
			projectiles.add(p);
		}
	}
