...
public class GameScreen2 extends Screen {
	...
	private static RobotLevel2 robot;
	public static HeliboyLevel2 hb, hb2;
	public static CoinLevel2 c1;
	
	private Image currentSprite, character, character2, character3, heliboy,
			heliboy2, heliboy3, heliboy4, heliboy5,coins;
	private Animation anim, hanim,hcoin;

	private ArrayList<TileLevel2> tilearray = new ArrayList<TileLevel2>();
	...
	public GameScreen2(Game game) {
		...
		robot = new RobotLevel2();
		hb = new HeliboyLevel2(340, 360);
		hb2 = new HeliboyLevel2(600, 360);
		c1 = new CoinLevel2(200,360);
		...
		heliboy = Assets.heliboyLevel2;
		heliboy2 = Assets.heliboyLevel2;
		heliboy3 = Assets.heliboyLevel2;
		heliboy4 = Assets.heliboyLevel2;
		heliboy5 = Assets.heliboyLevel2;

		coins = Assets.coinLevel2;
		...
		for (int j = 0; j < 12; j++) {
			...
			for (int i = 0; i < width; i++) {
				...
				if (i < line.length()) {
					...
					TileLevel2 t = new TileLevel2(i, j, Character.getNumericValue(ch));
					tilearray.add(t);
				}
	...
	private void updateScore() {
		...
		g.drawString("Score: " +GameScreen.getRobot().getScore()+" ",80, 80, paint3);
		/**g.drawString("Bonus: " +GameScreen.getRobot().getBonus(), 80, 80, paint4);*/
	}
	...
	private void updateRunning(List<TouchEvent> touchEvents, float deltaTime) {
		...
		for (int i = 0; i < projectiles.size(); i++) {
			ProjectileLevel2 p = (ProjectileLevel2) projectiles.get(i);
			if (p.isVisible() == true) {
				p.update();
			} else {
	...
	private void updateTiles() {
		...
		for (int i = 0; i < tilearray.size(); i++) {
			TileLevel2 t = (TileLevel2) tilearray.get(i);
			t.update();
		}
	...
	private void drawLevelUpUI() {
		...
		g.drawString("Tap to continue.", 400, 290, paint);
	}
	@Override
	public void pause() {
		if (state == GameState.Running)
	...
	public static RobotLevel2 getRobot() {
		// TODO Auto-generated method stub
		return robot;
	}
